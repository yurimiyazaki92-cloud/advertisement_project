...
#define swed_a_umlaut                                                          \
  { 0x05, 0x00, 0x0E, 0x01, 0x0F, 0x11, 0x0F, 0x00 }
#define swed_o_umlaut                                                          \
  { 0x05, 0x00, 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x00 }
#define swed_a_ring                                                            \
  { 0x04, 0x0A, 0x04, 0x00, 0x0E, 0x01, 0x0F, 0x00 }
...
public:
  ...
  void WriteSwedish(const char *text);
